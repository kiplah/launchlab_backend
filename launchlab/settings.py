"""
Django settings for launchlab project.
...
SECRET_KEY = 'django-insecure-#zsz7%-le&mp0@3cu^_r3^ct!8bw*o=4cj_+v#!adotocncw&z'
...
WSGI_APPLICATION = 'launchlab.wsgi.application'
